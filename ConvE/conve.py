...
class Main(object):
    ...
    def link_prediction_all(self, b_size:int = 128, threshold:float = 0.5):
        ...
        while len(links) > 0:
            ...
            with open(f"/home/hz/project/guohx/KGC/kg-reeval/ConvE/results/{self.p.name}", encoding='utf-8', mode='a') as file:
...
if __name__ == "__main__":
    ...
    # model.load_model("./models/person_09_03_2021_09:48:49")
    model.load_model("./models/person_18_03_2021_10:01:07")
    print("model device: {}".format(model.device))
    model.link_prediction_all()
    # model.link_prediction('沙溢', '好友')
    # model.link_prediction('孔祥熙', '小姨子')
    # model.link_prediction('田福军', '儿子')
